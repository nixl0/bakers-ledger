    ...
    <div class="border shadow-xl rounded-md p-8 flex flex-row justify-center">
        <form action="/districts/{{ $district->id }}" method="POST" class="w-2/3 flex flex-col space-y-6">
            ...
            <div class="flex items-center space-x-2">
                ...
                <input type="text" name="title" class="w-full p-4 text-gray-900 border rounded-md" value="{{ $district->title }}">
            </div>
            @error('title')
            ...
            <div class="flex items-center space-x-2">
                ...
                <input list="settlements" name="settlement_id" class="w-full p-4 text-gray-900 border rounded-md" value="{{ $district->settlement->id }}">
